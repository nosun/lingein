...
$(function(){
	...
	$('.jqzoom').jqzoom({zoomType: 'standard',zoomWidth: 526,zoomHeight: 540,xOffset: 20,yOffset: 0,lens:true,title:false,alwaysOn:false});

	$('select.usebox').selectBox();
	
	$('select[name="payment_method"]').change(function(e1){
		var value = $(this).find("option:selected").attr("value");
		$('.payment_disc_detail').css('display','none');
		$('.payment_disc_detail.'+value).css('display','block');
	});
