...
$(function(){
	...
	$('#userActionPanel #UAP-livechat dl dt').mouseout(function(){
        if($(this).hasClass('over')){$(this).removeClass('over');}});
	$('#Welcome_Section #curSelector').mouseover(function(){
        if($(this).hasClass('over')){return false;}
        else{$(this).addClass('over');}});
	$('#Welcome_Section #curSelector').mouseout(function(){
        if($(this).hasClass('over')){$(this).removeClass('over');}
	});
    ...
    $('#resultSortBarNew .showType select').change(function(){
    	$('#browse_filter input[name="pageRows"]').val($("#resultSortBarNew .showType select option:selected").val());
