...
//    $fp = fsockopen('www.sandbox.paypal.com', 80, $errno, $errstr, 30);
  ...
  public function callback($orderNumber=null)
  {
  	...
  	if ($_POST)
  	{
  		...
  		$orderInfo = $orderInstance->getOrederInfoByNumber($orderNumber);
  		...
  		else 
  		{
	  		...
	  		try 
	  		{
	  			log::save('debug', 'Call back requirement', dirname(__File__) . '/config.php');
	  			...
	  			//update order for the stripe charge id.
	  			$data = $orderInfo->data;
	  			$data['charge_id'] = $charge->id;
	  			$orderInstance->updateOrderDataField($orderInfo->oid, $data);
	  		...
	  		}catch(Stripe_CardError $e) 
	  		{
				...
				log::save('debug', 'Call back error', $e2);
			}
  		}
  	}
  	else 
  	{
  		$result['message'] = 'The payment transaction has been expired.';
  	}
