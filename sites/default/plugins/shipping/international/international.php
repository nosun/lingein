...
class International extends Shipping_Abstract
{
    ...
    public function calculate($goods_weight, $goods_amount, $goods_number)
    {
      if ($this->_configure['calculateway'] == 'num'){
        ...
        if(!isset($this->_configure['base_fee'])){
        	$this->_configure['base_fee'] = 0;
        }
        $fee = (isset($this->_configure['item_fee']) ? ($goods_number * $this->_configure['item_fee'] + $this->_configure['base_fee']) : $this->_configure['base_fee'] );
