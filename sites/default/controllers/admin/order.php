...
class Admin_Order_Controller extends Bl_Controller
{
  ...
  public function getInfoAction($oid)
  {
    ...
    $amazonShipping = new stdClass();
    $amazonShipping->name = "fast";
    $amazonShipping->displayName = 'DHL/UPS/FEDEX';
    $amazonShipping->description = '3 - 5 business days. More cheaper when purchased items reached some amount.';
    $shippingList['fast'] = $amazonShipping;
